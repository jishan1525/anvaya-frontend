...
const AddLead = () => {
  ...
  const formSubmitHandler = (event) => {
    ...
    const newLead = {
      ...
      priority: priority,
      timeToClose: parseInt(timeToClose) || 0,
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="md:pl-56 p-8 space-y-8">
        <div className="bg-white p-3 rounded-xl shadow-lg border border-gray-200 ml-6">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-xl text-sky-600 font-medium">Fetching data...</p>
            </div>
          )}
          ...
          {!loading && !error && (
            <form onSubmit={formSubmitHandler} className="space-y-6 ml-4">
              {/* NAME */}
              <div>
